  ...
  const svg = `
    <svg width="800" height="600" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="translate(50, 100)">
        ...
        <text x="300" y="0" class="text value">${stats.total_commits}</text>
      </g>

      <g transform="translate(50, 140)">
        <path class="icon" d="${Icons.pull_request_icon}" transform="translate(5, -17) scale(0.04)"/>
        <text x="40" y="0" class="text label">Total PRs:</text>
        <text x="300" y="0" class="text value">${stats.total_prs}</text>
      </g>
      ...
      <g transform="translate(50, 180)">
        ...
        <text x="300" y="0" class="text value">${stats.total_stars}</text>
      </g>

      <g transform="translate(50, 220)">
        <path class="icon" d="${Icons.merged_prs_icon}" transform="translate(5, -17) scale(0.04)"/>
        <text x="40" y="0" class="text label">Total PRs Merged:</text>
        <text x="300" y="0" class="text value">${stats.total_merged_prs}</text>
      </g>
      ...
      <g transform="translate(50, 260)">
        ...
        <text x="300" y="0" class="text value">${stats.merged_prs_percentage.toFixed(0)}%</text>
      </g>

      <g transform="translate(50, 300)">
        <path class="icon" d="${Icons.pr_reviewed_icon}" transform="translate(5, -17) scale(0.04)"/>
        <text x="40" y="0" class="text label">Total PRs Reviewed:</text>
        <text x="300" y="0" class="text value">${stats.total_prs_reviewed}</text>
      </g>

      <g transform="translate(50, 340)">
        <path class="icon" d="${Icons.issue_icon}" transform="translate(5, -17) scale(0.04)"/>
        <text x="40" y="0" class="text label">Total Issues:</text>
        <text x="300" y="0" class="text value">${stats.total_issues}</text>
      </g>

      <g transform="translate(50, 380)">
        <path class="icon" d="${Icons.discussions_started_icon}" transform="translate(5, -17) scale(0.04)"/>
        <text x="40" y="0" class="text label">Total Discussions Started:</text>
        <text x="300" y="0" class="text value">${stats.total_discussions_started}</text>
      </g>

      <g transform="translate(50, 420)">
        <path class="icon" d="${Icons.discussions_answered_icon}" transform="translate(5, -17) scale(0.04)"/>
        <text x="40" y="0" class="text label">Total Discussions Answered:</text>
        <text x="300" y="0" class="text value">${stats.total_discussions_answered}</text>
      </g>

      <g transform="translate(50, 460)">
        <path class="icon" d="${Icons.followers_icon}" transform="translate(5, -17) scale(0.04)"/>
        <text x="40" y="0" class="text label">Total Followers:</text>
        <text x="300" y="0" class="text value">${stats.followers}</text>
      </g>

      <g transform="translate(50, 500)">
        <path class="icon" d="${Icons.contributes_to_icon}" transform="translate(5, -17) scale(0.04)"/>
        <text x="40" y="0" class="text label">Contributed to:</text>
        <text x="300" y="0" class="text value">${stats.total_contributes_to}</text>
      </g>

      <g transform="translate(50, 540)">
        <path class="icon" d="${Icons.repo_icon}" transform="translate(5, -17) scale(0.04)"/>
        <text x="40" y="0" class="text label">Total Repos:</text>
        <text x="300" y="0" class="text value">${stats.total_repos}</text>
      </g>
